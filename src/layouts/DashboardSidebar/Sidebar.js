      ...
      <div className="navbar-default sidebar" style={{ marginLeft: '-20px' }} role="navigation">
        <div className="sidebar-nav navbar-collapse collapse">
          <ul className="nav in" id="side-menu">
            ...
            <li>
              <a href="{url}" onClick={(e) => { e.preventDefault(); history.push('/'); }} >
            ...
            <li className={classNames({ active: !this.state.chartsElementsCollapsed })}>
              ...
              >
                <li>
                  <a href="{url}" onClick={(e) => { e.preventDefault(); history.push('/flotcharts'); }} >
                    FlotCharts
                  </a>
                </li>
                <li>
            ...
            <li>
              <a href="{url}" onClick={(e) => { e.preventDefault(); history.push('/table'); }} >
                <i className="fa fa-table fa-fw" /> &nbsp;Tables
              </a>
            </li>

            <li>
              <a href="{url}" onClick={(e) => { e.preventDefault(); history.push('/forms'); }} >
            ...
            <li className={classNames({ active: !this.state.uiElementsCollapsed })}>
              ...
              >
                <li>
                  <a href="{url}" onClick={(e) => { e.preventDefault(); history.push('/panelwells'); }} >
                    Panels And Wells
                  </a>
                </li>
                <li>
                  <a href="{url}" onClick={(e) => { e.preventDefault(); history.push('/button'); }} >
                    Buttons
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href="{url}" onClick={(e) => { e.preventDefault(); history.push('/typography'); }} >
                    Typography
                  </a>
                </li>
                <li>
                  <a href="{url}" onClick={(e) => { e.preventDefault(); history.push('/icons'); }} >
                    Icons
                  </a>
                </li>
                <li>
                  <a href="{url}" onClick={(e) => { e.preventDefault(); history.push('/grid'); }} >
                    Grid
                  </a>
                </li>
              </ul>
            ...
            <li className={classNames({ active: !this.state.multiLevelDropdownCollapsed })}>
              ...
              >
                <li>
                  <a href="{url}" onClick={(e) => { e.preventDefault(); }}>Second Level Item</a>
                </li>
                <li>
                  <a href="{url}" onClick={(e) => { e.preventDefault(); }}>Second Level Item</a>
                </li>
                <li className={classNames({ active: !this.state.thirdLevelDropdownCollapsed })}>
                  ...
                  >
                    <li>
                      <a href="{url}" onClick={(e) => { e.preventDefault(); }}>Third Level Item</a>
                    </li>
                    <li>
                      <a href="{url}" onClick={(e) => { e.preventDefault(); }}>Third Level Item</a>
                    </li>
            ...
            <li className={classNames({ active: !this.state.samplePagesCollapsed })}>
              ...
              >
                <li>
                  <a href="{url}" onClick={(e) => { e.preventDefault(); history.push('/blank'); }} >
                    Blank
                  </a>
                </li>
                <li>
                  <a href="{url}" onClick={(e) => { e.preventDefault(); history.push('/login'); }} >
                    Login
                  </a>
                </li>
              </ul>
