		...
		<section className="artists-section">
			...
			<div class="artist-info">
				<p>
					...
					over hard hitting trap percussion reveals similarity to the sounds of
					<span style={{ textDecoration: "underline" }}> Lil Mosey </span> ,
					<span style={{ textDecoration: "underline" }}> Xavier Weeks </span>
					and<span style={{ textDecoration: "underline" }}> Jack Harlow </span>.
					From the bedroom trap style on “For the Weekend (feat. Rohan)” to the
					retro wave sampled melody on “The One (feat. Fetty Wap)” Moleta offers
					a
				...
				<p>
					...
					single on <span style={{ color: "#FA5570" }}> SoundCloud </span>which
					attracted more students than his remixes had. One year later in 2018,
					Nick held his first concert in Waldwick, NJ sponsored by Steve Madden.
					Today, “The One”, featuring multi platinum artist Fetty Wap has
					released on all platforms under Hidden Hill Recordings and 300
					Entertainment.
				</p>
			</div>
